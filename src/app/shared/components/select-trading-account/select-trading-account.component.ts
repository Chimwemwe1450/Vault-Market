...
@Component({
  selector: 'app-select-trading-account',
  templateUrl: './select-trading-account.component.html',
  styleUrls: ['./select-trading-account.component.scss'],
})
export class SelectTradingAccountComponent implements OnInit {
  ...
  applyCssClassToSelect() {
    const selectElement: HTMLIonSelectElement = this.mySelect.nativeElement;
    selectElement.interfaceOptions = {
  ...
  public async launchTransferModal(): Promise<void> {
